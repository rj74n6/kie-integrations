...
1. **Collect inputs** — Obtain from the user:
   ...
   If the user provides only a document without a schema, ask what fields they want extracted, then construct the schema. See `references/example_schemas.md` for common templates.
